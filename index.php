...
define('CAMPAIGN_ID', "a5f5582a49eafa443c400bd3a01e50e1");
define('REQUEST_LIVE_TIME', 3600);
define('ENC_KEY', 'fec7d06a9282d24d914a658d3cc66054');
define('MP_PARAM_NAME', 'bksess');
define('NOT_FOUND_TEXT', '<h1>Page not found</h1>');
define('CHECK_MCPROXY', 0);
define('CHECK_MCPROXY_PARAM', '272fba81efcb11b8d4e8341101ba307e');
define('CHECK_MCPROXY_VALUE', 'c75427436ba900544dc6fd022a719292bb56c9b81704bf5af1f1bf834d0abf7c');
...
function sendRequest($data, $path = 'index') {
    ...
    $data_to_post = array("cmp"=> CAMPAIGN_ID,"headers" => $data,"adapi" => '2.2', "sv" => '19042.3');
